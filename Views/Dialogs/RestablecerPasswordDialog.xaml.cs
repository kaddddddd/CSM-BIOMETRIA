...
namespace CSMBiometricoWPF.Views.Dialogs
{
    public partial class RestablecerPasswordDialog : Window
    {
        ...
        private void BtnCambiar_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                CustomMessageBox.Show("Ingrese el nombre de usuario.", "Validación",
            ...
            try
            {
                ...
                if (usuario == null)
                {
                    CustomMessageBox.Show("No se encontró un usuario con ese nombre.", "Usuario no encontrado",
                        MessageBoxButton.OK, MessageBoxImage.Warning);
                    return;
                }

                _repo.CambiarPassword(usuario.IdUsuario, pwdNueva.Password);
                CustomMessageBox.Show("Contraseña actualizada correctamente.", "Éxito",
